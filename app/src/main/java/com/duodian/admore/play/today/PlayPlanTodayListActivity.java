...
public class PlayPlanTodayListActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_play_plan_today_list);
...
//        params.put("trackId", String.valueOf(rowNum));
        Observable<HttpResult<PlayPlanTodayListInfo>> observable = iServiceApi.playSpreadTodayData(params, System.currentTimeMillis());
