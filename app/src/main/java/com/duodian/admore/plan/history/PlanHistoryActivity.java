package com.duodian.admore.plan.history;
...
public class PlanHistoryActivity extends BaseActivity implements OnPlanActionListener {
    ...
    private void initViews() {
        ...
        textView_title.setText(getResources().getString(R.string.spreadHistory));
    ...
    private void getPlans(final int rowNum) {
        ...
        Observable<HttpResult<PlanListInfo>> observable = iServiceApi.planHistoryData(params, System.currentTimeMillis());
